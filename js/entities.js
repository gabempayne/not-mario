var Entities = {
    init: function(data){
        ...
        var exitPipe = new Entities.helpers.ExitPipe(624, 443, 144, 168);
        
        var score = new Entities.helpers.Score(52, 38);// 290, 70
        
       var wallLocations = [[0, 0, 48, 600],[0, 528, 768, 72],
                           [192, 384, 336, 216], [726, 0, 42, 600]];
        
        var coinLocation = [[249, 150], [297, 150],[345, 150], [393, 150], [441, 150],
        ...
        coinLocation.forEach(function(location){
    ...
    helpers: {
        ...
        Jack: function(img, x, y, w, h){
            ...
            this.spriteAnimations = {
                walkRight: {
                    frames:[new Entities.helpers.Sprite(img, 16, 0, 16, 16),new Entities.helpers.Sprite(img, 32, 0, 16, 16),new Entities.helpers.Sprite(img, 48, 0, 16, 16)],
                    currentFrame: 0
              },
                walkLeft: {
                    frames:[new Entities.helpers.Sprite(img, 34, 18, 16, 16),new Entities.helpers.Sprite(img, 18, 18, 16, 16),new Entities.helpers.Sprite(img, 2, 18, 16, 16)],
                    currentFrame: 0
              },
